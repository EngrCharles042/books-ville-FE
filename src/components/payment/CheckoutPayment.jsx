...
export const CheckoutPayment = ({ handleBuy, handleStatus, setStatusTitle, setStatusMessage, setStatusColor, books, totalPrice, dep }) => {
    ...
    const bookPrice = totalPrice * 100;
    ...
    const handleSuccessfulPayment = async (e, transaction, url) => {
        ...
        try {
            await axios
                .post(`/transaction/${url}`, data, useConfig())
                .then((response) => {
                    enableStatus(
                        "Payment successful",
