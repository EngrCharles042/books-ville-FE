...
export const PaymentOptions = ({handleBuy}) => {
    ...
    return (
        <>
            <div className="bg-white mt-[20vh] shadow-lg mx-auto flex max-w-[592px] flex-col px-10 py-11 rounded-xl max-md:px-5">
                ...
                <div>
                    <button onClick={payWithFlutter} className="cursor-pointer hover:bg-green-600 transition text-center text-white text-sm font-semibold leading-5 whitespace-nowrap justify-center items-center bg-green-500 w-full max-w-full mt-2 px-16 py-3 rounded-xl self-start max-md:ml-2.5 max-md:mt-10 max-md:px-5">
                ...
                <div>
                    <button onClick={payWithPaystack} className="cursor-pointer hover:bg-green-600 transition text-center text-white text-sm font-semibold leading-5 whitespace-nowrap justify-center items-center bg-green-500 w-full max-w-full mt-6 px-16 py-3 rounded-xl self-start max-md:ml-2.5 max-md:mt-10 max-md:px-5">
                        <div className="flex gap-5 items-center justify-between mx-auto max-w-[12rem]">
                            <img
                                alt="paystack logo"
                                src={pLogo}
                ...
                <div onClick={handleBuy} className="text-green-500 text-sm leading-5 self-center whitespace-nowrap mt-4">
                    <span className="cursor-pointer font-semibold text-green-500 underline">Go back to</span>
                </div>
            </div>
        </>
    );
