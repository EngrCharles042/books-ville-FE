...
export const PaystackPayment = () => {
    ...
    const payWithPaystack = (e) => {
        ...
        payStack.newTransaction({
            key: `${import.meta.env.VITE_FLUTTER_PUBLIC_KEY}`,
            amount: 50000,
    ...
    return (
        <form onSubmit={payWithPaystack} className="bg-white mt-[3.5vh] shadow-2xl mx-auto flex max-w-[592px] flex-col px-10 py-11 rounded-xl max-md:px-5">
