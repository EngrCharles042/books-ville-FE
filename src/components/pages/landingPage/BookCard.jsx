...
export const BookCard = ({image, name, author, price}) => {
    return (
        <div className="flex flex-col items-stretch w-3/12 max-md:w-full max-md:ml-0">
            <div className="justify-center items-stretch shadow-lg flex grow flex-col max-md:mt-6">
                <img
                    loading="lazy"
                    src={image}
                ...
                <div className="text-center text-white text-sm font-medium leading-5 uppercase whitespace-nowrap justify-center items-center border bg-green-600 mt-3.5 px-16 py-7 rounded-md border-solid border-green-600 max-md:px-5">
                    ADD TO CART
                </div>
            </div>
        </div>
