        ...
        <div className="container mx-auto px-5 py-9 mt-[3rem] max-w-7xl">
            ...
            <div className="flex gap-[25px] items-center my-[5rem] md:mt-16" >
                ...
                <div className="flex flex-col justify-start ml-2">
                    <div className="text-4xl md:text-5xl font-bold text-green-500 leading-[72px] mb-1 md:mb-3" style={{ width: '780px', height: '117px', fontSize: '40px', fontWeight: 700, lineHeight: '59px', letterSpacing: '0em', textAlign: 'left' }}>
                        <span className="text-black">Access Your Personal Bookstore Online.</span>
                        <br />
                        <span className="text-green-500"> Buy Now</span>
                        <span className="text-black">, Read Now!</span>
                    </div>
