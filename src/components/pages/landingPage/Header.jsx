        ...
        <div className="container mx-auto px-1 py-9">
            <div className="flex justify-between items-center">
                ...
                <div className="buttons flex items-center gap-5">
                    ...
                    <Link to={"/user-signup"} className="hover:bg-gray-200 transition cursor-pointer text-green-500 text-base font-semibold leading-7 whitespace-nowrap justify-center items-stretch border grow px-11 py-3.5 rounded-xl border-solid border-green-500">
                        Sign Up
                    </Link>
