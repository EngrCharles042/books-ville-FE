export const DisplayedBookCard = ({bookTitle, author, shortDescription, genre, price}) => {
    return (
        <div className="justify-between content-start flex-wrap max-w-[867px]">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                <div className="flex flex-col items-stretch w-[24%] max-md:w-full max-md:ml-0">
                    <div className="justify-center items-center shadow-lg bg-slate-50 flex grow flex-col w-full max-md:mt-4">
                        <img
                            loading="lazy"
                            srcSet=" "
