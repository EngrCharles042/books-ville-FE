...
export const AdminSideBar = () => {
    const onSetContainerClick = useCallback(() => {
        // Please sync "Admin Screen/2 (view,edit)" to the project
    }, []);
    ...
    return (
        <div className="bg-white shadow-[0px_6px_16px_rgba(0,0,0,0.1599999964237213)]  min-h-[1024px] max-w-[260px] ">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                ...
                <div className="mt-3 flex justify-between gap-3 px-5 items-stretch">
                    <img
                        loading="lazy"
                ...
                <div onClick={onSetContainerClick} className="flex justify-between gap-3 px-5 mt-6 items-stretch cursor-pointer">
                    <img
                        loading="lazy"
